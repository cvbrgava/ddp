...
file_voltage = './Data/NOR_voltage.txt'
file_current = './Data/NOR_current.txt'
file_netlist = './Data/NOR.net'
input_list = ['ainp']
output_list = ['n003']
denominator = 40
...
def get_nonlinear_matrix(state,regions,Vth):
	...
	v1dot = (I[ 'm1' ] - I[ 'm2' ]  )/ Cpara_out
	v2dot = ( I[ 'm2' ] - I[ 'm3' ] ) / Cpara_M1

	v3dot = (I[ 'm3' ] - I[ 'm4' ] - I[ 'm5' ] - I[ 'm6' ] )/ Cpara_out
