...
cirname = 'Inverter cascaded with a 4 input NAND-gate  '
...
sim_end = 4.000000000000000e-006
file_voltage = './Data/inv_4inpNAND_voltage.txt'
file_current = './Data/inv_4inpNAND_current.txt'
file_netlist = './Data/inv_4inpNAND.net'
input_list = ['ainp']
output_list = ['nandout']
denominator = 40
