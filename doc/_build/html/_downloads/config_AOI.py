...
order = 3
sim_begin = 0.0
sim_end = 2.000000000000000e-006
file_voltage = './Data/AOI_voltage.txt'
file_current = './Data/AOI_current.txt'
file_netlist = './Data/AOI.net'
input_list = ['cinp']
output_list = ['n002']
denominator = 40
...
def get_nonlinear_matrix(state,regions,Vth):
	...
	v1dot = ( I[ 'm1' ] + I[ 'm2' ] - I[ 'm3' ] ) / Cpara_M1
	v2dot = ( I[ 'm3' ] - I[ 'm4' ] - I[ 'm5' ] ) / Cpara_M2
	v3dot = ( I[ 'm5' ] - I[ 'm6' ] ) / Cpara_M3
	#-----------------------------------------------------------------------------------------------------
...
#	eqs=sympy.Matrix( [(vd0dot),(vd12dot),(vd11dot),(vcmfb2dot),(vomdot),(vopdot),(vdc3dot),(vdc5dot),(vcmfb1dot),(vd1dot),(vd2dot),(ig9dot),(ig7dot)] )
	eqs = sympy.Matrix( [(v1dot),(v2dot),(v3dot)] )	    
	return eqs
...
def get_stateorder(state):
	...
	stateorder=sympy.Matrix([(state['n001']),(state['n002']),(state['n003']) ])
