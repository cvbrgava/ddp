...
# Solving the Actual Non Linear System
...
# Plot of the solution for Non Linear System
...
plt.figlegend([PWL,NL,L1],('Piece Wise Linear','Non-Linear','Linear at Origin'),'lower right')
plt.xlabel('Time')
plt.ylabel('Voltage')
...
L1=plt.plot(time,solnL1[:,9])
plt.title('Comparision b/w solutions')
plt.figlegend([PWL,NL,PWLMOR,L1],('Piece Wise Linear','Non-Linear','PWLMOR','Linear at Origin'),'lower right')
plt.xlabel('Time')
plt.ylabel('Voltage')
plt.show()
