...
file_voltage = './Data/singleOMP_cmfb_voltage.txt'
file_current = './Data/singleOMP_cmfb_current.txt'
file_netlist = './Data/singleOMP_cmfb.net'
input_list = ['n008','n005']
output_list = ['n001','n003']
constant_dict = {'vdd':5.0,'0':0,'cmirror':3.113045349452962}
denominator = 20
intg_end = 0.2e-6
...
#	ig7dot = 0.001 * ( vopdot - ( state[ 'ig7' ] / 7e-12 ) - vd1dot ) # > ig7
	...
	vout1Dot = (I[ 'm4' ] - I[ 'm1' ] +( ( state[ 'n001' ] - state[ 'n003' ] ) *0.5* ( 10e-8) ) ) * 1e15
	vout2Dot = (I[ 'm5' ] - I[ 'm2' ] - ( ( state[ 'n001' ] - state[ 'n003' ] ) *0.5* ( 10e-8) ) ) * 1e15
...
def get_stateorder(state):
	...
	stateorder=sympy.Matrix([(state['n001']),(state['n003']),(state['n004'])])
